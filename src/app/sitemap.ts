...
const routes = [
  ...
  { path: "/babybauch-shooting-kaufbeuren", priority: 0.9, changeFrequency: "monthly" as const },
  { path: "/newborn-fotograf-kaufbeuren", priority: 0.9, changeFrequency: "monthly" as const },
  { path: "/familienfotograf-kaufbeuren", priority: 0.9, changeFrequency: "monthly" as const },
